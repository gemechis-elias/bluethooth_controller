              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const MyHomePage()), // Replace MainPage with your desired page
                  );
                },
              ...
              child: const Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Your trusted farming companion! Get ready to revolutionize your agriculture journey with daily insights,controll the robot and more!",
                      style: TextStyle(
